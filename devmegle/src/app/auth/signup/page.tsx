    ...
    <main className="min-h-screen bg-stone-100 text-zinc-950">
      ...
      <section className="mx-auto flex max-w-xl items-center px-4 py-12 sm:px-6 lg:px-8">
        <form onSubmit={handleSubmit} className="w-full bg-white p-6 shadow-sm">
          ...
          {created && <p className="mt-4 rounded-md bg-emerald-50 p-3 text-sm text-emerald-700">Account ready. You can start matching now.</p>}
          ...
          <button
            disabled={isLoading}
            className="mt-6 w-full rounded-md bg-emerald-400 px-4 py-3 font-bold text-zinc-950 disabled:opacity-60"
          >
